class OptimizedLoginSlider {
    constructor() {
        this.slider = document.getElementById('loginSlider');
        this.currentSlide = 0;
        ...
        this.photos = [
            './static/media/photos/14.jpg',
            './static/media/photos/7.jpg',
            './static/media/photos/10.jpg',
            './static/media/photos/12.jpg',
            './static/media/photos/16.jpg',
            './static/media/photos/13.jpg'
        ];
...
document.addEventListener('DOMContentLoaded', () => {
    if (document.readyState === 'complete') {
        window.optimizedLoginSlider = new OptimizedLoginSlider();
    } else {
